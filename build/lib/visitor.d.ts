...
export declare class PGVisitor extends Visitor {
    ...
    protected VisitHasExpression(node: Token, context: any): void;
    protected VisitLambdaVariableExpression(node: Token, context: any): void;
    protected VisitLambdaPredicateExpression(node: Token, context: any): void;
    protected VisitAnyExpression(node: Token, context: any): void;
    protected VisitAllExpression(node: Token, context: any): void;
    protected VisitCollectionPathExpression(node: Token, context: any): void;
